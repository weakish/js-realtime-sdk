(function (global, factory) {
  ...
  */
  ...
  var _dec, _class;
  var Answer = (_dec = leancloudRealtime.messageType(-102), _dec(_class =
  /*#__PURE__*/
  function (_Signaling) {
    _inheritsLoose(Answer, _Signaling);
  ...
  var _dec$1, _class$1;
  var ICECandidate = (_dec$1 = leancloudRealtime.messageType(-103), _dec$1(_class$1 =
  /*#__PURE__*/
  function (_Signaling) {
    _inheritsLoose(ICECandidate, _Signaling);
  ...
  var _dec$2, _class$2;
  var Refusal = (_dec$2 = leancloudRealtime.messageType(-104), _dec$2(_class$2 =
  /*#__PURE__*/
  function (_Signaling) {
    _inheritsLoose(Refusal, _Signaling);
  ...
  var _dec$3, _class$3;
  var Cancelation = (_dec$3 = leancloudRealtime.messageType(-105), _dec$3(_class$3 =
  /*#__PURE__*/
  function (_Signaling) {
    _inheritsLoose(Cancelation, _Signaling);
  ...
  function (_EventEmitter) {
    _inheritsLoose(Call, _EventEmitter);
  ...
  /*#__PURE__*/
  function (_Call) {
    _inheritsLoose(OutgoingCall, _Call);
  ...
  /*#__PURE__*/
  function (_Call) {
    _inheritsLoose(IncomingCall, _Call);
  ...
  var _dec$4, _class$4;
  var Offer = (_dec$4 = leancloudRealtime.messageType(-101), _dec$4(_class$4 =
  /*#__PURE__*/
  function (_Signaling) {
    _inheritsLoose(Offer, _Signaling);
  ...
  /*#__PURE__*/
  function (_EventEmitter) {
    _inheritsLoose(WebRTCClient, _EventEmitter);
